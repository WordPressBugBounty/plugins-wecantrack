...
define('WECANTRACK_VERSION', '5.3.0');
...
// Overridable for local development (e.g. in wp-config.php via .wp-env.override.json);
// the shipped default always points at production.
if (!defined('WECANTRACK_API_BASE_URL')) {
...
if (!function_exists('wecantrack_plugin_activation')) {
    ...
    function wecantrack_plugin_activation()
    {
        ...
        add_option('wecantrack_snippet', 1, null);
